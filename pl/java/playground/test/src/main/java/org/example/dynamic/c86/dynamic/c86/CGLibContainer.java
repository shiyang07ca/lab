...
public class CGLibContainer {
  ...
  private static void init() {
    for (Class<?> cls : aspects) {
      ...
      if (aspect != null) {
        Method before =
            getMethod(cls, "before", new Class<?>[] {Object.class, Method.class, Object[].class});
        Method after =
            getMethod(
                cls,
                "after",
  ...
  static class AspectInterceptor implements MethodInterceptor {
    ...
    public Object intercept(Object object, Method method, Object[] args, MethodProxy proxy)
      ...
      List<Method> beforeMethods =
          getInterceptMethods(object.getClass().getSuperclass(), InterceptPoint.BEFORE);
      ...
      try {
        ...
        List<Method> afterMethods =
            getInterceptMethods(object.getClass().getSuperclass(), InterceptPoint.AFTER);
        ...
        // 执行exception方法
        List<Method> exceptionMethods =
            getInterceptMethods(object.getClass().getSuperclass(), InterceptPoint.EXCEPTION);
